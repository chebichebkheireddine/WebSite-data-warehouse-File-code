...
"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    <div class="navbar-header"><!-- navbar-header begin -->
        ...
        <a href="index.php?dashboard" class="navbar-brand"style="
    color: cornsilk;"
>Admin Area</a>
...
"><!-- dropdown-toggle begin -->
                ...
                <i class="fa fa-user"></i> <?php echo $admin_name." ".$admin_last; ?> <b class="caret"></b>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse begin -->
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                ...
                <i class="fa fa-bullhorn"></i>  ADD documnt 
                ...
                <ul id="products" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?Add_Do"> Ajouter Annances  </a>
                    </li><!-- li finish -->
