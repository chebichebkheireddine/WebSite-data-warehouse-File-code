      ...
      <nav class="nav ">
        ...
        <div class="nav_menu" id="nav_menu">
          ...
          <ul class="main-nav">
            ...
            <li><a href="Presentation.php"><i class="fa fa-clone"></i> Presentation</a>
              ...
              <div class="mega-menu">
                <ul class="links">
                  ...
                  <li>
                    <a href="user_do.php"><i class="fas fa-users"></i> Role Member</a>
                  </li>
                </ul>
              </div>
            </li>
            <!-- End About -->
            <li><a href="#"><i class="fa-regular fa-folder-open"></i>  Raport</a>
              <!-- Start Events -->
              <div class="mega-menu">
                <ul class="links">
            ...
            <li id="login-on"><a href="admin/login.php">Log in<i class="fa fa-user-circle"></i></a></li>
          </ul>
        </div>
