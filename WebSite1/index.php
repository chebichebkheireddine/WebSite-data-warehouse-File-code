        ...
        <section class="about">
            ...
            <div class="main">
                ...
                <div class="about-text">
                    ...
                    <p>Algerian NUSF. FASU est une ligue spécialisée pour les différents jeux sportifs dont la
                        participation est consacrée seulement pour les étudiants universitaires.</p>
                </div>
            </div>
        </section>
    </div>
        ...
        <section id="team">
            ...
            while ($row_info = mysqli_fetch_array($run_info)) {
                ...
                <div class='box'>
                    ...
                    <div class='details'>
                        <img src='images/khayro.png' alt=''>
                        <strong>CHEBICHEB KHEIREDDINE</strong>
                        <p>kheireddine@univ-tiaret.dz</p>
                    </div>

                    <div class='btn'>
                        <a href='https://www.facebook.com/kheir.eddine.1257604'><i class='fab fa-facebook-f'></i></a>
                        <a href='https://www.instagram.com/cb.kheireddine/?next=%2F'><i
