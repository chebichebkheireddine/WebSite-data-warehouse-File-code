      ...
      <section class="about">
        ...
        <div class="main">
          ...
          <div class="about-text">
             <h1>[ NU⅃⅃ ]</h1>
            <p>NULL was found to deliver a data warehouse solutions that positively impacted the project , this groupe is formed by 5 students from ibn khaldon's University . We achieve this project with a structured methodology that each method impact on every aspect of this project .The core team at NULL is formed by the groupe leader which can devide the project on the rest of groupe and also verify each step and the rest of the groupe members have their different role which every role is necessary for the next step to give a result at the end which is a form of  decisions that came from extracting the date and analyzing the data warehouse .</p>
          </div>
        </div>
      </section>
      </div>
